...
_KINDS: tuple[FileKind, ...] = (
    ...
    FileKind(".java",  "text/x-java",        "code", "code", 10),
    FileKind(".go",    "text/x-go",          "code", "code", 10),
    FileKind(".rs",    "text/x-rust",        "code", "code", 10),
    FileKind(".rb",    "text/x-ruby",        "code", "code", 10),
    FileKind(".php",   "application/x-php",  "code", "code", 10),
    FileKind(".cs",    "text/x-csharp",      "code", "code", 10),
    FileKind(".kt",    "text/x-kotlin",      "code", "code", 10),
    FileKind(".kts",   "text/x-kotlin",      "code", "code", 10),
    FileKind(".swift", "text/x-swift",       "code", "code", 10),
    FileKind(".c",     "text/x-c",           "code", "code", 10),
    FileKind(".h",     "text/x-c",           "code", "code", 10),
    FileKind(".cpp",   "text/x-c++",         "code", "code", 10),
    FileKind(".hpp",   "text/x-c++",         "code", "code", 10),
    FileKind(".vue",   "text/x-vue",         "code", "code", 10),
    FileKind(".xml",   "application/xml",    "code", "code", 10),
